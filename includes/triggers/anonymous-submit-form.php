...
class AutomatorWP_Contact_Form_7_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-contact-form-7' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-contact-form-7' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-contact-form-7' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-contact-form-7' ), '{post}' ),
            'action'            => 'wpcf7_submit',
